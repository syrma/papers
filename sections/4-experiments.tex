...
\begin{table}
  \begin{center}
    \begin{tabular}{cc}
      ...
      \verb!policy network architecture! & \verb!FDS! \\
      \verb!(policy network) learning_rate! & \verb!3e-4! \\
      \verb!(policy network) activation function & relu
      \verb!value network architecture! & \verb!FDS! \\
      \verb!(policy network) learning_rate! & \verb!3e-4! \\
      \verb!(policy network) activation function & 
